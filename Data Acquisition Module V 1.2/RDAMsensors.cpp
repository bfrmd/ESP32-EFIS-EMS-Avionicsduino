...
void sensorsRead()
{
  ...
  float tnvovd = (digitalValue / oilPgain) + numOilPoffset;                // tnvovd = Theoretical Numerical Value at the Output of the Voltage Divider. See the document: “The RDAM PCB”
  ...
  moduleData.oilP = iirFilter(prevFiltOilP, moduleData.oilP, 0.005);
  ...
  moduleData.iBus = iirFilter(prevFiltIBus, moduleData.iBus, 0.005);
  ...
  moduleData.iBat = iirFilter(prevFiltIBat, moduleData.iBat, 0.005);
